return {
	...
	opts = {
		...
		keymaps = {
			...
			["s"] = { "actions.select", opts = { horizontal = true }, desc = "Oil: открыть в горизонтальном сплите" },
			["v"] = { "actions.select", opts = { vertical = true }, desc = "Oil: открыть в вертикальном сплите" },
			["t"] = { "actions.select", opts = { tab = true }, desc = "Oil: открыть в новой вкладке" },
			["p"] = { "actions.preview", desc = "Oil: предпросмотр файла" },
			...
			["_"] = { "actions.open_cwd", mode = "n", desc = "Oil: открыть текущую рабочую директорию" },
			["`"] = { "actions.cd", mode = "n", desc = "Oil: сделать директорию текущей" },
			["~"] = { "actions.cd", opts = { scope = "tab" }, mode = "n", desc = "Oil: сделать директорию текущей для вкладки" },
			["gs"] = { "actions.change_sort", mode = "n", desc = "Oil: изменить сортировку" },
			["gx"] = { "actions.open_external", desc = "Oil: открыть внешней программой" },
			["g."] = { "actions.toggle_hidden", mode = "n", desc = "Oil: показать или скрыть скрытые файлы" },
