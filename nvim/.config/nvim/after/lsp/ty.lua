...
return {
	settings = {
		ty = {
			-- Не анализировать весь проект после каждого изменения.
			diagnosticMode = "openFilesOnly",

			-- ty будет единственным источником синтаксических ошибок.
			showSyntaxErrors = true,

			completions = {
				-- Предлагать символы, которые можно автоматически импортировать.
				autoImport = false,
